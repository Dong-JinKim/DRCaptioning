...
function layer:updateOutput(input)
  ...
  self.area1:cmul(box1[{{}, {}, 3}]:typeAs(self.area1), box1[{{}, {}, 4}]:typeAs(self.area1))--!!! type match
  self.area2:cmul(box2[{{}, {}, 3}]:typeAs(self.area2), box2[{{}, {}, 4}]:typeAs(self.area2))--!!! type match
  ...
  self.output:add(area1_expand:typeAs(self.output), -1, intersection:typeAs(self.output))--!!! type match
  self.output:add(area2_expand:typeAs(self.output)):pow(-1)--!!!type match
  self.output:cmul(intersection:typeAs(self.output))--!!!type match
