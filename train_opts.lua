...
function M.parse(arg)
  ...
  -- Data input settings
  cmd:option('-data_h5', 'data/VG-regions_R2.h5', ------------------------------VRD/VRD2/VGR_2longv3
    'HDF5 file containing the preprocessed dataset (from proprocess.py)')
  cmd:option('-data_json', 'data/VG-regions-dicts_R2.json',-------------------- VRD/VRD2/VGR_2longv3
  ...
  cmd:option('-test_num_proposals', 30,-- 1000 originally!!!
